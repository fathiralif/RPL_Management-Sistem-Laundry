...
CREATE TABLE IF NOT EXISTS services (
    ...
    unit_type ENUM('kg','item') DEFAULT 'kg',
...
(2, 'Pesanan Diterima', 'Pesanan ORD-02001 Anda telah diterima dan sedang diproses.'),
(2, 'Pesanan Siap', 'Pesanan ORD-02003 Anda sudah siap diambil!'),
(3, 'Pembayaran Berhasil', 'Pembayaran untuk ORD-02002 sebesar Rp30.000 berhasil.'),
...
-- =============================================
-- FIX: Konversi status lama ke status baru
-- (Jalankan ini jika ada data lama di DB)
-- =============================================
...
-- =============================================
-- FIX: Tambah transaksi dengan data berbeda-beda
-- supaya riwayat pembayaran customer tidak sama semua
-- =============================================
-- Hapus data lama yang bermasalah dulu jika ada
-- kemudian insert dengan transaction_code unik per transaksi
INSERT IGNORE INTO transactions (order_id, transaction_code, amount, payment_method, status, created_at) VALUES
...
-- Notifikasi admin untuk pembayaran
